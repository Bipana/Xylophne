      ...
      home: Scaffold(
        body: SafeArea(
          child: Column(children: <Widget>[
            ...
            keyNotes(color: Colors.orange, noteNumber: 3),
            keyNotes(color: Colors.blueAccent, noteNumber: 4),
            keyNotes(color: Colors.green, noteNumber: 5),
            keyNotes(color: Colors.purple, noteNumber: 6),
            keyNotes(color: Colors.teal, noteNumber: 7),
          ]),
        ),
      ),
    );
